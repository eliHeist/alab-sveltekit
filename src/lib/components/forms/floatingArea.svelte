...
<div class="input-group">
	<textarea {required} {type} {name} class="input dark:bg-dark-100 dark:text-white text-black bg-light-200" rows="5" />
	<label class="user-label dark:text-white text-black" for={name}>{label}</label>
</div>
